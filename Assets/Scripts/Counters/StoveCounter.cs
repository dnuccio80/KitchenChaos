...
public class StoveCounter : BaseCounter, IHasProgress
{
    ...
    public override void OnNetworkSpawn()
    {
        ...
        burningTimer.OnValueChanged += Burning_OnValueChanged;
    ...
    private void Burning_OnValueChanged(float previousValue, float newValue)
    {
    ...
    {       
        OnStateChanged?.Invoke(this, new OnStateChangeArgs
        {
            state = state.Value
        });
